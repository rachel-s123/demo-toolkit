...
// Nestle brand locale - Generated with basic content
const nestleStrings: SiteCopy = {
  "home": {
    "mainTitle": "Nestle Toolkit",
    "welcomeLead": "Welcome to Nestle's toolkit.",
    "helpYouIntro": "This toolkit is here to help you:",
    "helpYouList": [
      "Achieve launch new product",
    ...
    "journeySteps": {
      "launch": {
        "title": "Discovery",
        "description": "Explore Nestle's capabilities"
      },
      "generateTestRides": {
        "title": "Assessment",
        "description": "Evaluate your needs"
      },
      "inStore": {
      ...
      "welcome": {
        "title": "Mastery",
        "description": "Achieve success"
      }
    },
    "mainDescription": "Welcome to Nestle's comprehensive toolkit for launch new product."
  },
  "assets": {
    "title": "Nestle Assets",
